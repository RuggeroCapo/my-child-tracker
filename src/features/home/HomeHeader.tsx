  ...
  return (
    <header className="pt-safe">
      <div
        ...
        className="frost group relative flex min-h-20 w-full cursor-pointer items-center justify-between gap-4 rounded-[28px] p-3.5 pl-4 pr-4 text-left transition-all duration-150 ease-out-quart active:scale-[0.985] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus"
      >
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-sm font-medium text-ink-2 tabular">
            {age}
          </p>
        </div>
